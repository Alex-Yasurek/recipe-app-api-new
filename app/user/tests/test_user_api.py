...
class PrivateUserApiTests(TestCase):
    ...
    def setUp(self):
        ...
        self.client = APIClient()
        # force_authenticate = authenticate user we specify so we
        # can assume all requests made with client are now authenticated
    ...
    def test_update_user_profile(self):
        ...
        payload = {'name': 'Updated name', 'password': 'newpasswor456'}
        res = self.client.patch(ME_URL, payload)
        # get updated data for user from DB
